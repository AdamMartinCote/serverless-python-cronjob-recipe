...
## TLDR
 ...
 - test function locally
   - install requirements from `lambda_function` and `tests`
   - `make test`
 - Schedule frequency is defined in `template.yaml`
 - Function execution is defined in `lambda_function/scheduled_function/app.py`
